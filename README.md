...
### Backend Setup
Refer to https://laravel.com/docs/11.x/installation#docker-installation-using-sail to setup Laravel Sail. The vendor folder will be generated by running composer install. You will need to have NPM, and Composer already installed. You can run the project using Laravel Sail:
